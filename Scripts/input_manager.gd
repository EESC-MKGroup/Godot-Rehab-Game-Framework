...
enum Request { LIST_CONFIGS=1, GET_CONFIG=2, SET_CONFIG=3, SET_USER, DISABLE, ENABLE, PASSIVATE, OFFSET, CALIBRATE, OPERATE }
enum Reply { CONFIGS_LISTED=1, GOT_CONFIG=2, CONFIG_SET=3, USER_SET, DISABLED, ENABLED, PASSIVE, OFFSETTING, CALIBRATING, OPERATING }
